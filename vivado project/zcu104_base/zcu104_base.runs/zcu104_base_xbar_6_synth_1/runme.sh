...
HD_PWD='C:/Users/49842/Desktop/zcu104_base/zcu104_base.runs/zcu104_base_xbar_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zcu104_base_xbar_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zcu104_base_xbar_6.tcl
