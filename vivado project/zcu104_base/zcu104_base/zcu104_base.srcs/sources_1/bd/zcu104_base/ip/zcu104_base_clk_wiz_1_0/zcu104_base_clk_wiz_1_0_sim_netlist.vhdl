...
-- Command     : write_vhdl -force -mode funcsim -rename_top zcu104_base_clk_wiz_1_0 -prefix
--               zcu104_base_clk_wiz_1_0_ zcu104_base_clk_wiz_1_0_sim_netlist.vhdl
...
entity zcu104_base_clk_wiz_1_0_zcu104_base_clk_wiz_1_0_clk_wiz is
  port (
    clk_out1 : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
end zcu104_base_clk_wiz_1_0_zcu104_base_clk_wiz_1_0_clk_wiz;

architecture STRUCTURE of zcu104_base_clk_wiz_1_0_zcu104_base_clk_wiz_1_0_clk_wiz is
  signal clk_in1_zcu104_base_clk_wiz_1_0 : STD_LOGIC;
  signal clk_out1_zcu104_base_clk_wiz_1_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_zcu104_base_clk_wiz_1_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_zcu104_base_clk_wiz_1_0,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_zcu104_base_clk_wiz_1_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_zcu104_base_clk_wiz_1_0,
...
entity zcu104_base_clk_wiz_1_0 is
  ...
  attribute NotValidForBitStream of zcu104_base_clk_wiz_1_0 : entity is true;
end zcu104_base_clk_wiz_1_0;

architecture STRUCTURE of zcu104_base_clk_wiz_1_0 is
begin
inst: entity work.zcu104_base_clk_wiz_1_0_zcu104_base_clk_wiz_1_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1
    );
