...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {194.316} \
   CONFIG.CLKOUT1_PHASE_ERROR {186.521} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {33} \
   CONFIG.MMCM_CLKFBOUT_MULT_F {39.875} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI2 [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins ps_e/S_AXI_HP1_FPD]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI1 [get_bd_intf_pins axi_interconnect_1/M00_AXI] [get_bd_intf_pins ps_e/S_AXI_HP2_FPD]
  ...
  connect_bd_intf_net -intf_net interconnect_axihpm0fpd_M01_AXI [get_bd_intf_pins interconnect_axihpm0fpd/M01_AXI] [get_bd_intf_pins vcu_0/S_AXI_LITE]
  ...
  connect_bd_intf_net -intf_net vcu_0_M_AXI_DEC0 [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins vcu_0/M_AXI_DEC0]
  connect_bd_intf_net -intf_net vcu_0_M_AXI_DEC1 [get_bd_intf_pins axi_interconnect_0/S01_AXI] [get_bd_intf_pins vcu_0/M_AXI_DEC1]
  ...
  connect_bd_intf_net -intf_net vcu_0_M_AXI_MCU [get_bd_intf_pins axi_interconnect_hpc0/S01_AXI] [get_bd_intf_pins vcu_0/M_AXI_MCU]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_hpc0/ACLK] [get_bd_pins axi_interconnect_hpc0/M00_ACLK] [get_bd_pins axi_interconnect_hpc0/S00_ACLK] [get_bd_pins axi_interconnect_hpc0/S01_ACLK] [get_bd_pins axi_register_slice_0/aclk] [get_bd_pins axi_vip_0/aclk] [get_bd_pins axi_vip_1/aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins clk_wiz_1/clk_in1] [get_bd_pins interconnect_axifull/ACLK] [get_bd_pins interconnect_axifull/M00_ACLK] [get_bd_pins interconnect_axifull/S00_ACLK] [get_bd_pins interconnect_axihpm0fpd/ACLK] [get_bd_pins interconnect_axihpm0fpd/M00_ACLK] [get_bd_pins interconnect_axihpm0fpd/S00_ACLK] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins ps_e/maxihpm0_fpd_aclk] [get_bd_pins ps_e/saxihp1_fpd_aclk] [get_bd_pins ps_e/saxihp2_fpd_aclk] [get_bd_pins ps_e/saxihp3_fpd_aclk] [get_bd_pins ps_e/saxihpc0_fpd_aclk] [get_bd_pins vcu_0/m_axi_mcu_aclk]
  ...
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_hpc0/S01_ARESETN] [get_bd_pins axi_register_slice_0/aresetn] [get_bd_pins axi_vip_0/aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  ...
  connect_bd_net -net ps_e_pl_clk1 [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins interconnect_axihpm0fpd/M01_ACLK] [get_bd_pins ps_e/pl_clk0] [get_bd_pins rst_ps_e_100M/slowest_sync_clk] [get_bd_pins vcu_0/m_axi_dec_aclk] [get_bd_pins vcu_0/m_axi_enc_aclk] [get_bd_pins vcu_0/s_axi_lite_aclk]
  connect_bd_net -net rst_ps_e_100M_peripheral_aresetn [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins interconnect_axihpm0fpd/M01_ARESETN] [get_bd_pins rst_ps_e_100M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData0] [get_bd_addr_segs ps_e/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData1] [get_bd_addr_segs ps_e/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData0] [get_bd_addr_segs ps_e/SAXIGP4/HP2_LPS_OCM] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData1] [get_bd_addr_segs ps_e/SAXIGP4/HP2_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData0] [get_bd_addr_segs ps_e/SAXIGP4/HP2_QSPI] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces vcu_0/EncData1] [get_bd_addr_segs ps_e/SAXIGP4/HP2_QSPI] -force
  ...
  set_property PFM_NAME {xilinx:zcu104:zcu104_vcu_final:1.1} [get_files [current_bd_design].bd]
  set_property PFM.IRQ {intr {id 0 range 32}} [get_bd_cells /axi_intc_0]
  set_property PFM.AXI_PORT {S02_AXI {memport "S_AXI_HP" sptag "HP1" memory "ps_e HP1_DDR_LOW"} S03_AXI {memport "S_AXI_HP" sptag "HP1" memory "ps_e HP1_DDR_LOW"} S04_AXI {memport "S_AXI_HP" sptag "HP1" memory "ps_e HP1_DDR_LOW"} S05_AXI {memport "S_AXI_HP" sptag "HP1" memory "ps_e HP1_DDR_LOW"} S06_AXI {memport "S_AXI_HP" sptag "HP1" memory "ps_e HP1_DDR_LOW"} S07_AXI {memport "S_AXI_HP" sptag "HP1" memory "ps_e HP1_DDR_LOW"} S08_AXI {memport "S_AXI_HP" sptag "HP1" memory "ps_e HP1_DDR_LOW"} S09_AXI {memport "S_AXI_HP" sptag "HP1" memory "ps_e HP1_DDR_LOW"} S10_AXI {memport "S_AXI_HP" sptag "HP1" memory "ps_e HP1_DDR_LOW"} S11_AXI {memport "S_AXI_HP" sptag "HP1" memory "ps_e HP1_DDR_LOW"} S12_AXI {memport "S_AXI_HP" sptag "HP1" memory "ps_e HP1_DDR_LOW"} S13_AXI {memport "S_AXI_HP" sptag "HP1" memory "ps_e HP1_DDR_LOW"} S14_AXI {memport "S_AXI_HP" sptag "HP1" memory "ps_e HP1_DDR_LOW"} S15_AXI {memport "S_AXI_HP" sptag "HP1" memory "ps_e HP1_DDR_LOW"}} [get_bd_cells /axi_interconnect_0]
  set_property PFM.AXI_PORT {S02_AXI {memport "S_AXI_HP" sptag "HP2" memory "ps_e HP2_DDR_LOW"} S03_AXI {memport "S_AXI_HP" sptag "HP2" memory "ps_e HP2_DDR_LOW"} S04_AXI {memport "S_AXI_HP" sptag "HP2" memory "ps_e HP2_DDR_LOW"} S05_AXI {memport "S_AXI_HP" sptag "HP2" memory "ps_e HP2_DDR_LOW"} S06_AXI {memport "S_AXI_HP" sptag "HP2" memory "ps_e HP2_DDR_LOW"} S07_AXI {memport "S_AXI_HP" sptag "HP2" memory "ps_e HP2_DDR_LOW"} S08_AXI {memport "S_AXI_HP" sptag "HP2" memory "ps_e HP2_DDR_LOW"} S09_AXI {memport "S_AXI_HP" sptag "HP2" memory "ps_e HP2_DDR_LOW"} S10_AXI {memport "S_AXI_HP" sptag "HP2" memory "ps_e HP2_DDR_LOW"} S11_AXI {memport "S_AXI_HP" sptag "HP2" memory "ps_e HP2_DDR_LOW"} S12_AXI {memport "S_AXI_HP" sptag "HP2" memory "ps_e HP2_DDR_LOW"} S13_AXI {memport "S_AXI_HP" sptag "HP2" memory "ps_e HP2_DDR_LOW"} S14_AXI {memport "S_AXI_HP" sptag "HP2" memory "ps_e HP2_DDR_LOW"} S15_AXI {memport "S_AXI_HP" sptag "HP2" memory "ps_e HP2_DDR_LOW"}} [get_bd_cells /axi_interconnect_1]
  set_property PFM.AXI_PORT {S02_AXI {memport "S_AXI_HP" sptag "HPC0" memory "ps_e HPC0_DDR_LOW"} S03_AXI {memport "S_AXI_HP" sptag "HPC0" memory "ps_e HPC0_DDR_LOW"} S04_AXI {memport "S_AXI_HP" sptag "HPC0" memory "ps_e HPC0_DDR_LOW"} S05_AXI {memport "S_AXI_HP" sptag "HPC0" memory "ps_e HPC0_DDR_LOW"} S06_AXI {memport "S_AXI_HP" sptag "HPC0" memory "ps_e HPC0_DDR_LOW"} S07_AXI {memport "S_AXI_HP" sptag "HPC0" memory "ps_e HPC0_DDR_LOW"} S08_AXI {memport "S_AXI_HP" sptag "HPC0" memory "ps_e HPC0_DDR_LOW"} S09_AXI {memport "S_AXI_HP" sptag "HPC0" memory "ps_e HPC0_DDR_LOW"} S10_AXI {memport "S_AXI_HP" sptag "HPC0" memory "ps_e HPC0_DDR_LOW"} S11_AXI {memport "S_AXI_HP" sptag "HPC0" memory "ps_e HPC0_DDR_LOW"} S12_AXI {memport "S_AXI_HP" sptag "HPC0" memory "ps_e HPC0_DDR_LOW"} S13_AXI {memport "S_AXI_HP" sptag "HPC0" memory "ps_e HPC0_DDR_LOW"} S14_AXI {memport "S_AXI_HP" sptag "HPC0" memory "ps_e HPC0_DDR_LOW"} S15_AXI {memport "S_AXI_HP" sptag "HPC0" memory "ps_e HPC0_DDR_LOW"}} [get_bd_cells /axi_interconnect_hpc0]
